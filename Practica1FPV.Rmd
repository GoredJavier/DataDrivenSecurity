...
#Solución Opcion 2: Resultado 
suma_bits <- sum(txt_df$X7)
print(suma_bits)
...
#Solución: Opcion 2 - Solucion alterna a la anterior 

Contador_HTTP2 <- length (which(grepl("HTTP/0.2", epa_http$X5,)))
Cantidad_Total_Protocolos <- length (epa_http$X5)
Total_Diferente_HTTP2 <- Cantidad_Total_Protocolos - Contador_HTTP2

print(Total_Diferente_HTTP2)
